...
/**
 * Created by bill on 15/06/16.
 */
public class RemoveMedicationDialogFragment extends DialogFragment {
	...
	RemoveMedDialogListener mListener;
	...
	public void onAttach(Activity activity) {
		...
		try {
			...
			mListener = (RemoveMedDialogListener) activity;
		} catch (ClassCastException e) {
			// The activity doesn't implement the interface, throw exception
			throw new ClassCastException(activity.toString()
			  + " must implement RemoveMedDialogListener");
		}
	}
